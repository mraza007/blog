...
In my previous post, I showed you how to build a [CI/CD pipeline runner from scratch in Python](/2025/building-cicd-pipeline-runner-python/). We built something powerful: a system that could orchestrate jobs, manage dependencies, and pass artifacts between stages. It was the muscles of your deployment workflow.
